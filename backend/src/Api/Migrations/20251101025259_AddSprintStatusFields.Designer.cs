...
namespace Api.Migrations
{
    ...
    [Migration("20251101025259_AddSprintStatusFields")]
    partial class AddSprintStatusFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Domain.Demand", b =>
                {
                    ...
                    b.HasIndex("ModuleId", "OpenedAt");

                    b.HasIndex("ReporterAreaId", "OpenedAt");
            ...
            modelBuilder.Entity("Api.Domain.PermissionEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Active = true,
                            Category = "Demandas",
                            Code = "GerenciarBacklogs",
                            Description = "Criar e gerenciar backlogs, editar prioridades",
                            Name = "Gerenciar Backlogs"
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Sprint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Api.Domain.SprintItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Api.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CreatedAt = new DateTime(2025, 11, 1, 2, 52, 55, 254, DateTimeKind.Utc).AddTicks(3132),
                            Email = "admin@empresa.com",
                            IsSpecial = false,
                            Name = "Administrador",
                            PasswordHash = "$2a$11$rtrBxR3KEL2bUhIprBYVJ.8r7XqSUCh58CD0ygdyBXy8SxdEDZhnK",
                            Role = "Admin"
                        },
                        new
                        {
                            ...
                            Active = true,
                            CreatedAt = new DateTime(2025, 11, 1, 2, 52, 55, 851, DateTimeKind.Utc).AddTicks(5464),
                            Email = "gestor@empresa.com",
                            IsSpecial = false,
                            Name = "Gestor",
                            PasswordHash = "$2a$11$V0mQI38z89WuSprBmucXveQMLrHfl3sOSkC/BXITpvhWlLtc0pDau",
                            Role = "Gestor"
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Demand", b =>
                {
                    b.HasOne("Api.Domain.Backlog", "Backlog")
                        .WithMany("Demands")
            ...
            modelBuilder.Entity("Api.Domain.SprintItem", b =>
                {
                    ...
                    b.HasOne("Api.Domain.Sprint", "Sprint")
                        .WithMany("Items")
