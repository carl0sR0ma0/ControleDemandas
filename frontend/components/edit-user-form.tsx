...
export function EditUserForm({ user, onClose, onUserUpdated }: EditUserFormProps) {
  const [formData, setFormData] = useState({
    ...
    role: user.role,
    permissions: {
      acessarDashboard: user.permissions.includes("acessarDashboard"),
      visualizarDemandas: user.permissions.includes("visualizarDemandas"),
      registrarDemandas: user.permissions.includes("registrarDemandas"),
      editarStatus: user.permissions.includes("editarStatus"),
      gerenciarUsuarios: user.permissions.includes("gerenciarUsuarios"),
    },
  })
