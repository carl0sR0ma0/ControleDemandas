...
export interface DemandListItem{id:string;protocol:string;openedAt:string;occurrenceType:OccurrenceType;module:string;responsible?:string|null;reporterArea:string;classification:Classification;status:DemandStatus;nextActionResponsible?:string|null;estimatedDelivery?:string|null;documentUrl?:string|null}
...
export interface DemandDetail extends DemandListItem{description:string;observation?:string|null;requesterResponsible:string;unit:string;systemVersion?:string|null;productModule?:string|null;attachments:Attachment[];history:StatusHistory[]}
